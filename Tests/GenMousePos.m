...
% CHANGE BASED ON LABORAS OUTPUT DATA. Scaling the data to integers from 1 
% to the maximum pixel dimension streamlines the code.
% Example: If laboras outputs data from 0 (minimum x distance) to 1
% (maximum x distance). You need to scale that distance from 1 to 1920 or
% whatever size you want to final image to be.
...
for i = 1:size(mouseData, 1)
    ...
    % Find the bounding box around the x-y-position.
