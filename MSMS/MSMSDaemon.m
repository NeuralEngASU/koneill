...
Params.scenarioPath   = 'E:\MSMS\MSMS 2.1\Scenarios\MaleRightGhost'; % Path to the Scenario in MSMS
Params.handedness     = 2;        % Sends the handedness of the model to be used. (1 = Left, 2 = Right)
...
% %%
% 
% inputStr = 'Finger1=0.0;Finger2=0.0;Finger3=0.0;Finger4=0.0;Finger5=0.0;SpherePos1=1.0;SpherePos2=0.0;SpherePos3=0.0;SpherePos4=0.0;SpherePos5=0.0;WristRoll=0.0;WristPitch=0.5;WristYaw=0.5;SphereApp1=1.0;SphereApp2=0.0;SphereApp3=0.0;SphereApp4=0.0;SphereApp5=0.0;';
% m_MSMS.MoveFingerProp( inputStr );
% 
