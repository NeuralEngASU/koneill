...
function [] = TrialRaw( CSCData, channel, timeBounds, varargin)
...
timeStamps = CSCData.timeStamps{channel};
...
voltData = h5read(CSCData.hdf5FileName, ['/', tempChanName], [1, timeIdx(1)], [1, length(timeIdx)]);

voltData = voltData./1; % Convert to correct units: V. mV, uV ...
