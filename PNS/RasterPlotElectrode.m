function [] = RasterPlotElectrode( trialStruct, trialType, trials, trialLen, spikeTimes, H, varargin )
...
for i = 1:numChans
    for k = 1:numTrials
        ...
        trialSpikesIdx = spikeTimes{i} > startTime & spikeTimes{i} < [startTime + trialSize];
        trialSpikes = spikeTimes{i}(trialSpikesIdx);
